...
/*     */ 
/*     */ public abstract interface IUploadCallback extends IInterface
/*     */ {
...
/*     */     public Stub()
/*     */     {
/*  17 */       attachInterface(this, "io.rong.imlib.IUploadCallback");
/*     */     }
/*     */ 
...
/*  26 */         return null;
/*     */       }
/*  28 */       IInterface iin = obj.queryLocalInterface("io.rong.imlib.IUploadCallback");
/*  29 */       if ((iin != null) && ((iin instanceof IUploadCallback))) {
/*  30 */         return (IUploadCallback)iin;
/*     */       }
...
/*     */       {
/*     */       case 1598968902:
/*  44 */         reply.writeString("io.rong.imlib.IUploadCallback");
/*  45 */         return true;
/*     */       case 1:
/*  49 */         data.enforceInterface("io.rong.imlib.IUploadCallback");
/*     */ 
...
/*  54 */         return true;
/*     */       case 2:
/*  58 */         data.enforceInterface("io.rong.imlib.IUploadCallback");
/*     */ 
...
/*  63 */         return true;
/*     */       case 3:
/*  67 */         data.enforceInterface("io.rong.imlib.IUploadCallback");
/*     */ 
...
/*  90 */         return "io.rong.imlib.IUploadCallback";
/*     */       }
/*     */ 
...
/*     */         try {
/*  97 */           _data.writeInterfaceToken("io.rong.imlib.IUploadCallback");
...
/*     */         try {
/* 112 */           _data.writeInterfaceToken("io.rong.imlib.IUploadCallback");
...
/*     */         try {
/* 127 */           _data.writeInterfaceToken("io.rong.imlib.IUploadCallback");
 ...
 * Qualified Name:     io.rong.imlib.IUploadCallback
